# Codex Project Guidelines for Macrostrat Japan
...
1. **Pre-check**: Inspect `loop2_governance/specs/CONTEXT_HANDOFF.json` to confirm no active conflicting job from Claude Code.
